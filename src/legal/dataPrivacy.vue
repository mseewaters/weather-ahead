<template>
  <div class="policy">
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Weather Ahead.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Weather Ahead, accessible from <a href="https://www.weather-ahead.com" rel="external nofollow noopener" target="_blank">https://www.weather-ahead.com</a></p>
    </li>
    <li>
    ...
    <p>We may eventually use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</p>
    <ul>
    <li>
    ...
    <ul>
    <li>By email: weatheraheadinfo@gmail.com</li>
    </ul>
  </div>
</template>
